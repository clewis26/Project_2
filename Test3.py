# -*- coding: utf-8 -*-
"""
Created on Sun Oct 09 01:17:16 2016
...
tfidf_vectorizer = TfidfVectorizer(max_features=50000, ngram_range=(1,2), max_df=0.9, stop_words='english', sublinear_tf=True) 
train_matrix = tfidf_vectorizer.fit_transform(X_train)
test_matrix = tfidf_vectorizer.transform(X_test)

logreg = linear_model.LogisticRegression(C=1.7, solver='sag',multi_class='multinomial', max_iter=200,n_jobs=4 )
